                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="<?= base_url('admin/Admin/v_edit_admin') ?>" method="post" enctype="multipart/form-data">
                                                <input type="hidden" value="<?= $a['admin_id'] ?>" name="id">
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" value="<?= $a['admin_nama'] ?>" placeholder="Masukan Nama" name="nama" class="form-control" />
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" value="<?= $a['admin_email'] ?>" placeholder="Masukan Email" name="email" class="form-control" />
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                ...
                                                                <input type="hidden" value="<?= $a['admin_password'] ?>" name="password_default">
